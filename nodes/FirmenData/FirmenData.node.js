...
var FirmenData = /** @class */ (function () {
    function FirmenData() {
        this.description = {
            ...
            description: 'Look up German company data: register profiles, financials, shareholders and UBO',
            ...
            properties: [
                ...
                // ---------------------------------------------------------------
                {
                    ...
                    description: 'The company identifier returned by Search or Autocomplete as <code>eu_id</code>',
                    displayOptions: {
                        show: {
                            resource: ['company'],
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            type: 'string',
                            default: '',
                            description: 'Pagination cursor from a previous response (<code>pagination.next_cursor</code>)',
